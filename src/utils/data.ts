...
export const servicesData: ServiceProps[] = [
    ...
    },
    {
        ...
        longDesc: "Distressed corporations suffering from unique or unusual circumstances require expertise to restore and improve value. STOC’s multi-disciplinary approach provides clients with comprehensive methods to achieve rapid results with industry-specific financial, operational, and strategic solutions.",
        image: "/rt-1.jpeg"
