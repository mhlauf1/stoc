...
export default function NewsLetterBadge() {
  return (
    <Link className="z-10" href="/contact">
      <button className="bg-white/10 tracking-wide cursor-pointer flex text-sm border  gap-1 border-white/20 hover:border-white/60 duration-200 hover:text-white hover:shadow-xs text-neutral-50 px-4 py-1.5 rounded-full">
