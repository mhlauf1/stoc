    ...
    <div className="flex mt-8 mb-2 md:mb-0 flex-col items-start md:pt-0 flex-1">
      <div>
        <motion.h1
          ...
          className="text-[#EFFFF3] text-3xl md:text-5xl lg:text-6xl font-gambetta md:max-w-[20ch] leading-tight tracking-tight"
        >
        ...
        <motion.p
          ...
          animate="visible"
          variants={textVariants}
          className="text-[#EFFFF3] tracking-tight text-lg md:text-xl mt-4 md:max-w-[52ch]"
        >
