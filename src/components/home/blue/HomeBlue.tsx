...
export default function Hero() {
  return (
    <section className="relative h-screen  flex">
      <div className="absolute top-0 left-0 right-0 bg-black/40 bottom-0"></div>
      ...
      <div className="flex z-10 flex-col w-full px-6 md:px-12 lg:px-32 items-start justify-center">
        ...
        <p className="mt-6 mb-12 text-lg md:text-xl max-w-lg text-white">
