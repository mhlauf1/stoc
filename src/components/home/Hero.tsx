  ...
  return (
    <section className="relative h-[98vh] flex">
      ...
      <div className="flex z-10 flex-col gap-4 pt-[30vh] pb-16 w-full px-4 md:px-[5%] items-start justify-between">
        ...
        <div className="flex flex-col gap-6 md:gap-8 pb-8 items-start">
          ...
          <motion.p
            ...
            animate="visible"
            variants={textVariants}
            className="text-lg text-start tracking-tight md:text-xl w-full md:max-w-[40ch] text-white"
          >
          ...
          <motion.div
            ...
            animate="visible"
            variants={textVariants}
            className="flex flex-col md:flex-row md:justify-center items-center md:w-auto w-full gap-4  md:gap-6"
          >
            <Link
