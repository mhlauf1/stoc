  ...
  return (
    <section className="bg-[#F7F7F7]  px-6 md:px-12 lg:px-32 py-24 md:py-32">
      <div className="flex flex-col md:flex-row gap-12">
        <div className="flex flex-col gap-8 md:gap-16 flex-1 items-center md:items-start">
          ...
          <p className="leading-8 text-lg text-neutral-600 text-center md:text-start md:mt-4">
