...
const Hero: React.FC = () => (
  <section className="md:h-[95vh]  relative flex flex-col md:flex-row gap-4 pt-[12vh] md:pt-12 bg-[#041E40] items-center px-4 md:px-[5%]">
    <div className="flex flex-col mt-8 mb-2 md:mb-0 items-start md:pt-0 flex-1">
      <div>
        <motion.h1
          ...
          className="text-[#bacaec] text-3xl md:text-5xl lg:text-6xl font-gambetta md:max-w-[22ch] leading-tight tracking-tight"
        >
