...
const StepItem: React.FC<StepItemProps> = ({ title, text, Icon }) => (
  <div className="flex flex-col px-4 md:px-12 items-start  gap-1 md:gap-3">
    <div className="flex flex-row items-center gap-2">
      ...
      <h3 className="text-lg text-neutral-800 md:text-xl font-medium">
        {title}
      </h3>
    </div>
  ...
  <section className="px-6 bg-linear-to-r from-[#F7F7F7] to-[#ebebeb] w-full md:px-12 lg:px-24 py-12  md:py-20">
    <div className="flex items-center md:items-start flex-col">
      ...
      <div className="flex flex-col gap-4 mt-2">
        <p className="leading-7 md:leading-8  md:max-w-[60ch] text-md md:text-lg text-center md:text-start text-neutral-500">
