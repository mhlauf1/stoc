...
import { coreServicesData } from "@/utils/data";
...
const ServiceCard: React.FC<ValueProps> = ({ Icon, title, description }) => (
  ...
  >
    ...
    <h3 className="text-3xl md:text-4xl max-w-[15ch] tracking-tight font-gambetta mb-4">
      {title}
    </h3>
...
const CoreServices: React.FC = () => (
  <section className="flex flex-col pt-24 px-4 sm:px-12 md:px-32 pb-16 md:pb-28">
