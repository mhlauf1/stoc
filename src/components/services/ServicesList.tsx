    ...
    <section className="bg-[#F7F7F7] md:mb-12 py-16 md:py-20 px-4 md:px-[5%]">
      <div className="flex flex-col md:flex-row gap-8">
        <div className="flex flex-col flex-1 items-center md:items-start">
          ...
          <h3 className="text-2xl md:text-3xl lg:text-4xl text-center md:text-start md:max-w-[20ch] mt-2 font-gambetta tracking-tight leading-snug">
          ...
          <p className="text-neutral-600 text-start tracking-tight font-medium md:max-w-[58ch] mt-1 text-md md:text-lg">
            Key Services:
          </p>
