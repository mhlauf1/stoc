  ...
  return (
    <section className="relative h-[95vh]  flex">
      ...
      <div className="flex z-10 flex-col w-full px-6 md:px-12 lg:px-32 items-start pb-24 pt-24 md:pt-64">
        ...
        <h1 className="text-5xl text-start tracking-tighter max-w-[20ch] md:text-6xl font-gambetta lg:text-7xl leading-tight text-white">
          Built on Expertise. <br />{" "}
          <span className="font-gambetta italic">Defined by Trust.</span>
        </h1>
        <p className="mt-8 mb-16  text-lg text-start md:text-xl max-w-2xl text-white">
